...
# Top specific template phrases to trigger entire sentence discard
template_phrases = [
    "Defizite auf",
    ...
    "vor der Entscheidung anzuhören", "vor der Entscheidung anzuhören",
    "obliegt den zuständigen Landesbehörden",
    "Vorschriften dieses Gesetzes sind zu beachten",
    "Ermessensentscheidungen sind zu begründen", "Ermessensentscheidungen sind zu begründen",
    ...
    "Erfüllungsaufwand", "Erfüllungsaufwand",
    "Vollzug obliegt den Ländern", "Vollzug obliegt den Ländern",
    "Ich danke Ihnen für die Aussprache",
    "bitte um Zustimmung",
    "Koalition hat sich viel vorgenommen",
    "ob sie Wort hält", "ob sie Wort hält"
]
...
print("\n--- Top 30 Bigram Differences After Sentence Discarding ---")
